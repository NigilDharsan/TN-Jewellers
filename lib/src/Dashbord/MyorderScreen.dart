...
class _MyOrderScreenState extends State<MyOrderScreen> {
  ...
  final List<String> mydream = ["EAR RINGS", "GOLD", "ON-STOCK", "WEIGHT", "KARAT"];
        ...
        children: [
                    ...
                    child: DropdownButton<String>(
                      ...
                      items: ["MOST RECENT", "OLDEST FIRST"].map((String value) {
                        return DropdownMenuItem<String>(
                          value: value,
                          child: Text(value, style: TextStyle(fontSize: 10, fontWeight: FontWeight.w400)),
                        );
                      }).toList(),
                      onChanged: (newValue) {
                        setState(() {
          ...
          Expanded(
            child: isGridView
              ...
              itemBuilder: (context, index) => buildProductGrid(products[index]),
            )
                : ListView.builder(
              padding: EdgeInsets.all(10),
              itemCount: products.length,
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Text(title, style: TextStyle(fontSize: 8, fontWeight: FontWeight.w400, color: Colors.white)),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 5),
          Text(product["delivery"] ?? "No Delivery Info", textAlign: TextAlign.center),
          Text(product["order"] ?? "No Order Status", textAlign: TextAlign.center),
          SizedBox(height: 5),
          Align(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(child: Text(product["delivery"] ?? "No Delivery Info")),
              SizedBox(width: 10),
